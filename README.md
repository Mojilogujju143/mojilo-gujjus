...
<Variable name="keycolor" description="Main Color" type="color" default="#e5f0ee" hideEditor="true"  value="#3f97d6"/>
...
<Group description="Body">
  ...
  <Variable name="body.text.font" description="Font" type="font" default="$(loraNormal20)"  value="400 20px Lato, sans-serif"/>
  <Variable name="body.text.color" description="Color" type="color" default="#292929"  value="#292929"/>
  <Variable name="body.link.color" description="Link color" type="color" default="#25a186"  value="#3f97d6"/>
  <Variable name="body.link.visited.color" description="Visited link color" type="color" default="$(body.link.color)"  value="#3f97d6"/>
  <Variable name="body.link.hover.color" description="Link Hover Color" type="color" default="$(body.link.color)"  value="#40a125"/>
  <Variable name="blog.title.font" description="Blog Title Font" type="font" default="$(openSansBold24)"  value="normal 400 24px Chewy"/>
  <Variable name="blog.title.color" description="Blog Title Color" type="color" default="#000"  value="#205113"/>
</Group>

<Group description="Featured post" selector=".heroPost">
  <Variable name="heropost.main.background.color" description="Featured post main background color" type="color" default="#25a186"  value="#5f615c"/>
  ...
  <Variable name="heropost.main.link.color" description="Featured post main link color" type="color" default="#173752"  value="#8ac0e6"/>
  <Variable name="heropost.secondary.background.color" description="Featured post background color (secondary)" type="color" default="#e5f0ee"  value="#cccccc"/>
  <Variable name="heropost.secondary.text.color" description="Featured post text color (secondary)" type="color" default="#000"  value="#3d3c3f"/>
  <Variable name="heropost.secondary.button.color" description="Featured post buttons color (secondary)" type="color" default="#25a186"  value="#3d3c3f"/>
  <Variable name="heropost.secondary.dropcap.color" description="Featured post drop cap color (secondary)" type="color" default="$(heropost.secondary.button.color)"  value="#3d3c3f"/>
</Group>
...
<Group description="Header" selector=".centered-top-container">
  ...
  <Variable name="header.background.color" description="Background color" type="color" default="#fff"  value="#ececec"/>
  <Variable name="header.description.font" description="Description font" type="font" default="$(openSansNormal14)"  value="400 14px EB Garamond, serif"/>
  ...
  <Variable name="header.pages.color" description="Page list color" type="color" default="#25a186"  value="#3f97d6"/>
  <Variable name="header.pages.selected.color" description="Page list color (selected page)" type="color" default="$(header.pages.color)"  value="#3f97d6"/>
  <Variable name="header.items.color" description="Text color" type="color" default="#25a186"  value="#3f97d6"/>
  <Variable name="header.items.font" description="Text font" type="font" default="$(openSansSemibold14)"  value="700 14px Lato, sans-serif"/>
</Group>

<Group description="Search">
  <Variable name="search.input.font" description="Input font" type="font" default="$(openSansSemibold16)"  value="700 16px Lato, sans-serif"/>
</Group>

<Group description="Feed" selector=".widget.Blog">
  <Variable name="feed.title.font" description="Post title font" type="font" default="$(openSansBold36)"  value="400 44px EB Garamond, serif"/>
  <Variable name="feed.title.color" description="Post title color" type="color" default="#25a186"  value="#3d3c3f"/>
  <Variable name="feed.subtitle.font" description="Post subtitle font" type="font" default="$(openSansSemibold16)"  value="700 16px Lato, sans-serif"/>
  ...
  <Variable name="feed.text.font" description="Post text font" type="font" default="$(loraNormal20)"  value="400 20px Lato, sans-serif"/>
  <Variable name="feed.text.color" description="Post text color" type="color" default="rgba(0,0,0,0.84)"  value="#3d3c3f"/>
  <Variable name="feed.button.font" description="Button font" type="font" default="$(openSansSemibold14)"  value="700 14px Lato, sans-serif"/>
  <Variable name="feed.button.color" description="Button color" type="color" default="#25a186"  value="#3f97d6"/>
</Group>
...
<Group description="Sharing" selector=".sharing">
  <Variable name="sharing.background.color"
      ...
      type="color"
      default="$(body.background.color)"  value="#ececec"/>
  <Variable name="sharing.text.color" description="Sharing text color"
      type="color"
      default="$(feed.button.color)"  value="#3f97d6"/>
  <Variable name="sharing.icons.color"
      description="Sharing icons color"
      type="color"
      default="$(sharing.text.color)"  value="#3f97d6"/>
</Group>

<Group description="Dialogs" selector=".subscribe-popup">
  <Variable name="dialog.title.font" description="Dialog title font" type="font" default="$(openSansBold24)"  value="700 24px Lato, sans-serif"/>
  ...
  <Variable name="dialog.input.font" description="Dialog input font" type="font" default="$(openSansNormal14)"  value="700 14px Lato, sans-serif"/>
  ...
  <Variable name="dialog.action.font" description="Dialog action font" type="font" default="$(openSansSemibold14)"  value="700 14px Lato, sans-serif"/>
  <Variable name="dialog.action.color" description="Dialog action color" type="color" default="$(feed.button.color)"  value="#3f97d6"/>
</Group>
            ...
            <div class='main_header_elements container'>
              ...
              <div class='blog-name'>
                <b:section id='header' name='Header' showaddelement='false'>
                  <b:widget id='Header1' locked='true' title='gujarati and hindi poetry and shayari (મથાળું)' type='Header' visible='true'>
                    <b:widget-settings>
              ...
              <b:if cond='data:view.isLayoutMode or data:widgets any (w =&gt; w.sectionId == &quot;search_top&quot;)'>
                <div class='search'>
                  ...
                  <b:section id='search_top' name='Search (Top)' showaddelement='false'>
                    <b:widget id='BlogSearch1' locked='true' title='આ બ્લૉગ શોધો' type='BlogSearch' visible='true'>
          ...
          <nav role='navigation'>
            <b:section class='centered-top-secondline' id='page_list_top' name='Page List (Top)' showaddelement='false'>
              <b:widget id='PageList1' locked='true' title='' type='PageList' visible='true'>
                <b:widget-settings>
                  <b:widget-setting name='pageListJson'><![CDATA[{"link1":{"href":"https://www.youtube.com/channel/UCt593DMvr-To6Usd2Xw2x-A/","position":1,"title":"Youtube Channel"},"link0":{"href":"https://instagram.com/mojilo_gujju_0143?utm_medium=copy_link","position":0,"title":"Instagram ID"},"link2":{"href":"  https://www.facebook.com/mojilo.gujju.143/","position":2,"title":"FB PAGE"}}]]></b:widget-setting>
                  <b:widget-setting name='homeTitle'>હ&#2763;મ</b:widget-setting>
                </b:widget-settings>
                <b:includable id='main'>
  <b:include name='widget-title'/>
  <b:include name='content'/>
                  ...
                  <b:section class='main' id='page_body' name='Page Body' showaddelement='false'>
                    <b:widget cond='data:view.isHomepage' id='FeaturedPost1' locked='true' title='Featured post' type='FeaturedPost' visible='true'>
                      <b:widget-settings>
                        ...
                        <b:widget-setting name='postId'>5923193158386191325</b:widget-setting>
    ...
    <b:include name='snippetedPosts'/>
          ...
          <b:message name='messages.share'/>
            ...
            <b:include cond='data:posts.any' data='{                                postDisplay: data:postDisplay,                                post: data:posts.first                              }' name='heroPost'/>
                    ...
                    <b:widget id='Blog1' locked='true' title='બ્લૉગ પોસ્ટ્સ' type='Blog' visible='true'>
                      <b:widget-settings>
                        <b:widget-setting name='commentLabel'>comments</b:widget-setting>
                        <b:widget-setting name='showShareButtons'>true</b:widget-setting>
                        <b:widget-setting name='authorLabel'>By Mojilo Gujju 👑👑</b:widget-setting>
                        ...
                        <b:widget-setting name='style.textcolor'>#3f97d6</b:widget-setting>
                        <b:widget-setting name='showCommentLink'>true</b:widget-setting>
                        <b:widget-setting name='style.urlcolor'>#40a125</b:widget-setting>
      ...
      <div id='comment-popup'>
        ...
        <aside class='sidebar-container sidebar-invisible' role='complementary'>
          ...
          <b:section class='sidebar' id='sidebar' name='Sidebar' preferred='yes'>
            <b:widget id='Profile1' locked='false' title='મારા વિશે' type='Profile' visible='true'>
              <b:widget-settings>
    ...
    <b:loop values='data:posts' var='post'>
      <li>
        <a expr:href='data:post.url'><data:post.title/></a>
            ...
            <b:widget id='Label1' locked='false' title='લેબલ્સ' type='Label' visible='false'>
              <b:widget-settings>
    ...
    <b:else/>
      <b:include name='defaultAdUnit'/>
          ...
          <b:with value='&quot;/* Done in css. */&quot;' var='style'>
            ...
            <b:widget id='LinkList1' locked='false' title='Social Plugin' type='LinkList' visible='false'>
              <b:widget-settings>
                <b:widget-setting name='sorting'>NONE</b:widget-setting>
                <b:widget-setting name='text-1'>instagram</b:widget-setting>
                <b:widget-setting name='link-1'>https://instagram.com/mojilo_gujju_0143?utm_medium=copy_link</b:widget-setting>
                <b:widget-setting name='text-0'>facebook</b:widget-setting>
                <b:widget-setting name='link-2'>https://www.youtube.com/channel/UCt593DMvr-To6Usd2Xw2x-A/</b:widget-setting>
                <b:widget-setting name='link-0'>  https://www.facebook.com/mojilo.gujju.143/</b:widget-setting>
     ...
     <b:loop values='data:links' var='link'>
       <li><a expr:href='data:link.target'><data:link.name/></a></li>
            ...
            <b:widget id='Image1' locked='false' title='About Us' type='Image' visible='false'>
              <b:widget-settings>
                <b:widget-setting name='displayUrl'>https://blogger.googleusercontent.com/img/a/AVvXsEg5zbw2xfsyS2QwdrQY4xvY_u1BrszYJ9Oq8RFeu3RmM4XDwMbgSumPIbw0wvkCFD6QRqVTpbI3Etsr6pAUQ9mO0KEWNYSQn6KpXT1_hsUx1mMaQdK72f0tzCWOx-twohRUvFeJTF5J-2CjAbt7gIDF4R08wEYK91Bwm2KEGq2ModNmXmcu9QFYy1yD=s150</b:widget-setting>
                ...
                <b:widget-setting name='link'><![CDATA[/<p xmlns:dct="http://purl.org/dc/terms/"> <a rel="license" href="http://creativecommons.org/publicdomain/mark/1.0/"> <img src="http://i.creativecommons.org/p/mark/1.0/88x31.png"      style="border-style: none;" alt="Public Domain Mark" /> </a> <br /> This work (<span property="dct:title">mojilo gujju 0143 </span>, by <a href="https://www.youtube.com/channel/UCt593DMvr-To6Usd2Xw2x-A/" rel="dct:creator"><span property="dct:title">Mojilo Gujju 0143</span></a>), identified by <a href="https://mojilogujjus.blogspot.com" rel="dct:publisher"><span property="dct:title">MALO PATIDAR</span></a>, is free of known copyright restrictions. </p>]]></b:widget-setting>
    ...
    <b:if cond='data:caption'>
      <span class='caption'><data:caption/></span>
          ...
          <div class='post-outer-container'>
            ...
            <b:widget id='Label3' locked='false' title='Tags' type='Label' visible='false'>
              <b:widget-settings>
    ...
    <b:include cond='data:this.display == &quot;cloud&quot;' name='cloud'/>
      ...
      <b:section class='footer' id='footer' name='Footer' showaddelement='false' tag='footer'>
        <b:widget id='Attribution1' locked='true' title='' type='Attribution' visible='true'>
          <b:widget-settings>
            <b:widget-setting name='copyright'>MojiloGujjus</b:widget-setting>
          </b:widget-settings>
          <b:includable id='main' var='this'>
  <div class='widget-content'>
    <div class='blogger'>
